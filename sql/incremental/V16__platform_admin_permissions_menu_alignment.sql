...
SET permissions = '["agent:read","agent:view","agent:create","agent:update","agent:edit","agent:delete","agent:publish","agent:audit","skill:read","skill:view","skill:create","skill:update","skill:edit","skill:delete","skill:publish","skill:audit","mcp:view","mcp:create","mcp:edit","mcp:delete","mcp:publish","app:view","app:create","app:update","app:edit","app:delete","dataset:read","dataset:view","dataset:create","dataset:update","dataset:edit","dataset:delete","dataset:apply","user:manage","user:read","user:create","user:update","user:delete","role:manage","role:read","role:create","role:update","role:delete","org:manage","org:read","org:create","org:update","org:delete","api-key:manage","apikey:read","apikey:create","apikey:delete","resource-grant:manage","grant-application:review","resource:audit","system:config","monitor:view","audit:manage","developer:portal","developer-application:review"]',
    update_time = NOW()

...
INSERT INTO `t_audit_item` VALUES (2, 'skill', 8, 'OCR 文字识别', 'ocr-recognize', '识别图片中的文字内容', 'http_api', 'cloud', '王开发', '2026-03-20 14:30:00', 'testing', NULL, NULL, '2026-03-25 09:59:40', '2026-03-22 10:58:54');
...
-- ----------------------------
INSERT INTO `t_call_log` VALUES ('cl-001', 'trace-a001', '1', 'web-search', '4', 'qwen-turbo', 'POST /chat', 'success', 200, 1150, 120, 350, 0.009400, NULL, '10.0.0.1', '2026-03-22 10:58:54');
INSERT INTO `t_call_log` VALUES ('cl-002', 'trace-a002', '1', 'web-search', '4', 'qwen-turbo', 'POST /chat', 'success', 200, 980, 80, 280, 0.007200, NULL, '10.0.0.1', '2026-03-22 10:58:54');
INSERT INTO `t_call_log` VALUES ('cl-003', 'trace-a003', '2', 'smart-tutor', '3', 'qwen-turbo', 'POST /chat', 'success', 200, 2800, 200, 1500, 0.034000, NULL, '10.0.0.2', '2026-03-22 10:58:54');
INSERT INTO `t_call_log` VALUES ('cl-004', 'trace-a004', '3', 'paper-polish', '3', 'gpt-4o', 'POST /chat', 'success', 200, 3500, 500, 800, 6.500000, NULL, '10.0.0.2', '2026-03-22 10:58:54');
INSERT INTO `t_call_log` VALUES ('cl-005', 'trace-a005', '4', 'campus-qa', '4', 'qwen-turbo', 'POST /chat', 'success', 200, 650, 50, 200, 0.005000, NULL, '10.0.0.3', '2026-03-22 10:58:54');
INSERT INTO `t_call_log` VALUES ('cl-006', 'trace-a006', '6', 'code-assistant', '3', 'qwen-turbo', 'POST /chat', 'success', 200, 1900, 300, 600, 0.018000, NULL, '10.0.0.2', '2026-03-22 10:58:54');
INSERT INTO `t_call_log` VALUES ('cl-007', 'trace-a007', '1', 'web-search', '2', 'qwen-turbo', 'POST /chat', 'error', 500, 5200, 100, 0, 0.002000, NULL, '10.0.0.4', '2026-03-22 10:58:54');
INSERT INTO `t_call_log` VALUES ('cl-008', 'trace-a008', '6', 'code-assistant', '4', 'qwen-turbo', 'POST /chat', 'success', 200, 1600, 250, 550, 0.016000, NULL, '10.0.0.3', '2026-03-22 10:58:54');
INSERT INTO `t_call_log` VALUES ('cl-009', 'trace-a009', '2', 'smart-tutor', '2', 'qwen-turbo', 'POST /chat', 'success', 200, 2200, 180, 1200, 0.027600, NULL, '10.0.0.4', '2026-03-22 10:58:54');
INSERT INTO `t_call_log` VALUES ('cl-010', 'trace-a010', '4', 'campus-qa', '4', 'qwen-turbo', 'POST /chat', 'timeout', 504, 15000, 60, 0, 0.001200, NULL, '10.0.0.3', '2026-03-22 10:58:54');
...
INSERT INTO `t_favorite` VALUES (3, 4, 'skill', 2, '2026-03-22 10:58:54');
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '平台角色表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '统一资源主表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_resource
-- ----------------------------
INSERT INTO `t_resource` VALUES (1, 'agent', 'web-search', '联网搜索', '通过搜索引擎实时检索互联网信息并汇总回答', 'published', 'cloud', 1, 1, 1, 0, '2026-03-22 10:58:54', '2026-03-22 10:58:54');
INSERT INTO `t_resource` VALUES (2, 'agent', 'smart-tutor', '智能备课助手', '辅助教师快速生成教案、课件大纲和教学活动设计', 'published', 'internal', 3, 2, 1, 0, '2026-03-22 10:58:54', '2026-03-22 10:58:54');
INSERT INTO `t_resource` VALUES (3, 'agent', 'paper-polish', '论文润色', '对学术论文进行语言润色、格式规范和学术表达优化', 'published', 'cloud', 1, 10, 3, 0, '2026-03-22 10:58:54', '2026-03-22 10:58:54');
INSERT INTO `t_resource` VALUES (4, 'agent', 'campus-qa', '校园问答', '回答校园生活、教务政策、办事流程等常见问题', 'testing', 'internal', 3, 1, 1, 0, '2026-03-22 10:58:54', '2026-03-22 10:58:54');
INSERT INTO `t_resource` VALUES (5, 'agent', 'image-gen', '图像生成', '根据文字描述生成高质量图像', 'draft', 'cloud', 2, 3, 3, 0, '2026-03-22 10:58:54', '2026-03-22 10:58:54');
INSERT INTO `t_resource` VALUES (6, 'agent', 'code-assistant', '代码助手', '辅助编写、调试和解释代码，支持多种编程语言', 'published', 'cloud', 1, 3, 3, 0, '2026-03-22 10:58:54', '2026-03-22 10:58:54');
INSERT INTO `t_resource` VALUES (8, 'skill', 'lantu-mcp-server', '兰智通 MCP Server', '兰智通平台内置 MCP 工具集合，提供知识库检索、文档生成等能力', 'testing', 'internal', 3, 3, 1, 0, '2026-03-22 10:58:54', '2026-03-25 09:59:40');
INSERT INTO `t_resource` VALUES (9, 'skill', 'local-kb-search', '本地知识库搜索', '在校内知识库中检索相关文档和信息', 'published', 'internal', 3, 1, 1, 0, '2026-03-22 10:58:54', '2026-03-22 10:58:54');
INSERT INTO `t_resource` VALUES (10, 'skill', 'word-gen', 'Word文档生成', '根据输入内容自动生成规范的 Word 文档', 'published', 'internal', 3, 11, 1, 0, '2026-03-22 10:58:54', '2026-03-22 10:58:54');
INSERT INTO `t_resource` VALUES (11, 'skill', 'ppt-gen', 'PPT生成', '根据主题和大纲自动生成演示文稿', 'published', 'internal', 3, 11, 1, 0, '2026-03-22 10:58:54', '2026-03-22 10:58:54');
INSERT INTO `t_resource` VALUES (12, 'skill', 'schedule-query', '日程查询', '查询个人或部门的日程安排', 'published', 'internal', 3, 1, 1, 0, '2026-03-22 10:58:54', '2026-03-22 10:58:54');
INSERT INTO `t_resource` VALUES (13, 'skill', 'data-analysis', '数据分析工具', '对上传的结构化数据进行统计分析和可视化', 'published', 'cloud', 1, 8, 3, 0, '2026-03-22 10:58:54', '2026-03-22 10:58:54');
INSERT INTO `t_resource` VALUES (14, 'skill', 'translate', '多语言翻译', '支持中英日韩等多语言互译', 'published', 'cloud', 1, 3, 1, 0, '2026-03-22 10:58:54', '2026-03-22 10:58:54');
INSERT INTO `t_resource` VALUES (15, 'skill', 'ocr-recognize', 'OCR 文字识别', '识别图片中的文字内容', 'deprecated', 'cloud', 2, 3, 3, 0, '2026-03-22 10:58:54', '2026-03-25 09:28:55');
INSERT INTO `t_resource` VALUES (23, 'app', 'campus-card', '校园一卡通查询', '查询校园卡余额、消费记录和充值', 'published', 'internal', NULL, 15, 1, 0, '2026-03-22 10:58:54', '2026-03-22 10:58:54');
INSERT INTO `t_resource` VALUES (24, 'app', 'library-seat', '图书馆座位预约', '在线预约图书馆自习座位', 'published', 'internal', NULL, 15, 1, 0, '2026-03-22 10:58:54', '2026-03-22 10:58:54');
INSERT INTO `t_resource` VALUES (25, 'app', 'course-table', '课表查询', '查看个人课程表和考试安排', 'published', 'internal', NULL, 6, 1, 0, '2026-03-22 10:58:54', '2026-03-22 10:58:54');
INSERT INTO `t_resource` VALUES (26, 'dataset', 'cs-papers-2026', '计算机论文库2026', '2026年度计算机领域核心期刊论文集', 'deprecated', 'knowledge', NULL, 10, 3, 0, '2026-03-22 10:58:54', '2026-03-25 09:28:38');
INSERT INTO `t_resource` VALUES (27, 'dataset', 'student-scores', '学生成绩数据', '近三年全校本科生成绩统计数据（脱敏）', 'published', 'department', NULL, 8, 1, 0, '2026-03-22 10:58:54', '2026-03-22 10:58:54');
INSERT INTO `t_resource` VALUES (28, 'dataset', 'campus-news-corpus', '校园新闻语料', '兰州大学官网新闻语料库（用于NLP训练）', 'testing', 'knowledge', NULL, 10, 3, 0, '2026-03-22 10:58:54', '2026-03-22 10:58:54');
INSERT INTO `t_resource` VALUES (29, 'mcp', 'smoke-mcp-1774368649', 'Smoke MCP', 'smoke test', 'published', 'internal', NULL, NULL, 1, 0, '2026-03-25 00:10:50', '2026-03-25 00:10:50');
INSERT INTO `t_resource` VALUES (30, 'mcp', 'smoke2-mcp-1774368774', 'Smoke2 MCP', 'smoke test 2', 'published', 'internal', NULL, NULL, 1, 0, '2026-03-25 00:12:55', '2026-03-25 00:12:55');
...
CREATE TABLE `t_resource_skill_ext`  (
  `resource_id` bigint NOT NULL,
  `skill_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
-- ----------------------------
INSERT INTO `t_resource_skill_ext` VALUES (8, 'mcp', 'TOOL', NULL, NULL, '{\"url\": \"http://ai.lzu.edu.cn/mcp\", \"timeout\": 30}', NULL, 1, 50);
INSERT INTO `t_resource_skill_ext` VALUES (9, 'mcp', 'TOOL', 8, 'search_file', '{\"url\": \"http://ai.lzu.edu.cn/mcp/kb\", \"timeout\": 10}', '{\"type\": \"object\", \"properties\": {\"limit\": {\"type\": \"integer\"}, \"query\": {\"type\": \"string\"}}}', 1, 30);
INSERT INTO `t_resource_skill_ext` VALUES (10, 'mcp', 'TOOL', 8, 'file', '{\"url\": \"http://ai.lzu.edu.cn/mcp/word\", \"timeout\": 30}', '{\"type\": \"object\", \"properties\": {\"title\": {\"type\": \"string\"}, \"content\": {\"type\": \"string\"}}}', 1, 10);
INSERT INTO `t_resource_skill_ext` VALUES (11, 'mcp', 'TOOL', 8, 'file', '{\"url\": \"http://ai.lzu.edu.cn/mcp/ppt\", \"timeout\": 60}', '{\"type\": \"object\", \"properties\": {\"topic\": {\"type\": \"string\"}, \"outline\": {\"type\": \"array\"}}}', 1, 5);
INSERT INTO `t_resource_skill_ext` VALUES (12, 'mcp', 'TOOL', 8, 'answer', '{\"url\": \"http://ai.lzu.edu.cn/mcp/schedule\", \"timeout\": 5}', '{\"type\": \"object\", \"properties\": {\"date\": {\"type\": \"string\"}, \"userId\": {\"type\": \"string\"}}}', 1, 50);
INSERT INTO `t_resource_skill_ext` VALUES (13, 'mcp', 'TOOL', 8, 'app', '{\"url\": \"https://api.analysis.com/v1\", \"timeout\": 30}', '{\"type\": \"object\", \"properties\": {\"query\": {\"type\": \"string\"}, \"datasetId\": {\"type\": \"string\"}}}', 1, 10);
INSERT INTO `t_resource_skill_ext` VALUES (14, 'http_api', 'TOOL', NULL, 'answer', '{\"url\": \"https://api.translate.com/v1\", \"timeout\": 10}', '{\"type\": \"object\", \"properties\": {\"to\": {\"type\": \"string\"}, \"from\": {\"type\": \"string\"}, \"text\": {\"type\": \"string\"}}}', 1, 30);
INSERT INTO `t_resource_skill_ext` VALUES (15, 'http_api', 'TOOL', NULL, 'answer', '{\"url\": \"https://api.ocr.com/v1\", \"timeout\": 15}', '{\"type\": \"object\", \"properties\": {\"imageUrl\": {\"type\": \"string\"}, \"language\": {\"type\": \"string\"}}}', 1, 20);
...
INSERT INTO `t_resource_tag_rel` VALUES (7, 'skill', 1, 3, '2026-03-22 10:58:54');
INSERT INTO `t_resource_tag_rel` VALUES (8, 'skill', 2, 5, '2026-03-22 10:58:54');
...
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '资源版本表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `t_resource_version` VALUES (7, 8, 'v1', 'active', 1, '{\"spec\": {\"url\": \"http://ai.lzu.edu.cn/mcp\", \"timeout\": 30}, \"status\": \"published\", \"endpoint\": \"http://ai.lzu.edu.cn/mcp\", \"invokeType\": \"mcp\", \"displayName\": \"兰智通 MCP Server\", \"resourceCode\": \"lantu-mcp-server\"}', '2026-03-24 21:23:03');
INSERT INTO `t_resource_version` VALUES (8, 9, 'v1', 'active', 1, '{\"spec\": {\"url\": \"http://ai.lzu.edu.cn/mcp/kb\", \"timeout\": 10}, \"status\": \"published\", \"endpoint\": \"http://ai.lzu.edu.cn/mcp/kb\", \"invokeType\": \"mcp\", \"displayName\": \"本地知识库搜索\", \"resourceCode\": \"local-kb-search\"}', '2026-03-24 21:23:03');
INSERT INTO `t_resource_version` VALUES (9, 10, 'v1', 'active', 1, '{\"spec\": {\"url\": \"http://ai.lzu.edu.cn/mcp/word\", \"timeout\": 30}, \"status\": \"published\", \"endpoint\": \"http://ai.lzu.edu.cn/mcp/word\", \"invokeType\": \"mcp\", \"displayName\": \"Word文档生成\", \"resourceCode\": \"word-gen\"}', '2026-03-24 21:23:03');
INSERT INTO `t_resource_version` VALUES (10, 11, 'v1', 'active', 1, '{\"spec\": {\"url\": \"http://ai.lzu.edu.cn/mcp/ppt\", \"timeout\": 60}, \"status\": \"published\", \"endpoint\": \"http://ai.lzu.edu.cn/mcp/ppt\", \"invokeType\": \"mcp\", \"displayName\": \"PPT生成\", \"resourceCode\": \"ppt-gen\"}', '2026-03-24 21:23:03');
INSERT INTO `t_resource_version` VALUES (11, 12, 'v1', 'active', 1, '{\"spec\": {\"url\": \"http://ai.lzu.edu.cn/mcp/schedule\", \"timeout\": 5}, \"status\": \"published\", \"endpoint\": \"http://ai.lzu.edu.cn/mcp/schedule\", \"invokeType\": \"mcp\", \"displayName\": \"日程查询\", \"resourceCode\": \"schedule-query\"}', '2026-03-24 21:23:03');
INSERT INTO `t_resource_version` VALUES (12, 13, 'v1', 'active', 1, '{\"spec\": {\"url\": \"https://api.analysis.com/v1\", \"timeout\": 30}, \"status\": \"published\", \"endpoint\": \"https://api.analysis.com/v1\", \"invokeType\": \"mcp\", \"displayName\": \"数据分析工具\", \"resourceCode\": \"data-analysis\"}', '2026-03-24 21:23:03');
INSERT INTO `t_resource_version` VALUES (13, 14, 'v1', 'active', 1, '{\"spec\": {\"url\": \"https://api.translate.com/v1\", \"timeout\": 10}, \"status\": \"published\", \"endpoint\": \"https://api.translate.com/v1\", \"invokeType\": \"rest\", \"displayName\": \"多语言翻译\", \"resourceCode\": \"translate\"}', '2026-03-24 21:23:03');
INSERT INTO `t_resource_version` VALUES (14, 15, 'v1', 'active', 1, '{\"spec\": {\"url\": \"https://api.ocr.com/v1\", \"timeout\": 15}, \"status\": \"testing\", \"endpoint\": \"https://api.ocr.com/v1\", \"invokeType\": \"rest\", \"displayName\": \"OCR 文字识别\", \"resourceCode\": \"ocr-recognize\"}', '2026-03-24 21:23:03');
...
-- ----------------------------
INSERT INTO `t_usage_record` VALUES (1, 4, 'web-search', '联网搜索', 'agent', '对话', '兰州大学2026年招生政策', '根据最新公布的招生简章...', 470, 1150, 'success', '2026-03-22 10:58:54');
INSERT INTO `t_usage_record` VALUES (2, 4, 'campus-qa', '校园问答', 'agent', '对话', '图书馆几点关门', '兰州大学图书馆开放时间为...', 250, 650, 'success', '2026-03-22 10:58:54');
INSERT INTO `t_usage_record` VALUES (3, 3, 'smart-tutor', '智能备课助手', 'agent', '对话', '生成高等数学第一章教案', '教案：高等数学 - 函数与极限...', 1700, 2800, 'success', '2026-03-22 10:58:54');
INSERT INTO `t_usage_record` VALUES (4, 3, 'code-assistant', '代码助手', 'agent', '对话', '用Python写一个快速排序', 'def quick_sort(arr):...', 900, 1900, 'success', '2026-03-22 10:58:54');
INSERT INTO `t_usage_record` VALUES (5, 4, 'local-kb-search', '本地知识库搜索', 'skill', '调用', '机器学习期末考试重点', '根据知识库检索到3篇相关文档...', 150, 650, 'success', '2026-03-22 10:58:54');

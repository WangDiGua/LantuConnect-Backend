...
public class GatewayInvokeProperties {
    ...
    public static class BindingExpansion {
        ...
        /**
         * invoke Agent 时若 payload（或 {@code _lantu}）含 {@code activeSkillIds}，
         * 是否将各 Skill 上的 {@code skill_depends_mcp} 绑定 MCP 与 Agent 自身绑定 MCP 合并后写入 {@code _lantu.bindingExpansion}。
         */

...
public class FileStorageSupport {
    ...
    public MinioClient createMinioClient() {
        var minio = runtimeAppConfigService.file().getMinio();
        String minioEndpoint = minio.getEndpoint();
        String minioAccessKey = minio.getAccessKey();
        String minioSecretKey = minio.getSecretKey();
    ...
    public String extractMinioObjectKey(String artifactUri) {
        var minio = runtimeAppConfigService.file().getMinio();
        String minioEndpoint = minio.getEndpoint();
        String minioBucket = minio.getBucket();
    ...
    public InputStream openMinioObject(String objectKey) {
        try {
            String minioBucket = runtimeAppConfigService.file().getMinio().getBucket();
